...
(function (global, factory) {
    ...
    function toast(options = {}) {
        ...
        if (position.startsWith("bottom"))
            container.style.flexDirection = orderReversed
                ? "column-reverse"
                : "column";
        else
            container.style.flexDirection = orderReversed
        ...
        if (showProgressBar) {
            ...
            if (autoClose) {
                progressBar.style.animation = `progress ${duration / 1000
                    }s linear forwards`;
        ...
        if (showActionButton && actionButtonLabel) {
            ...
            if (
                ...
                !getComputedStyle(theme).border
            )
                actionBtn.style.border = `1px solid ${getComputedStyle(theme).color}`;
